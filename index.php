...
<!--                                    </div>-->
                        ...
                        <div class="wizard-step" data-wizard-type="step">
                            <div class="wizard-wrapper">
                                ...
                                <div class="wizard-label">
                                    <h3 class="wizard-title">
                                        II. Infomacion del denunciado(s)
                                    </h3>
<!--                                    <div class="wizard-desc">-->
        ...
        <div class="login-content flex-column-fluid d-flex flex-column p-10">
            ...
            <div class="text-right d-flex justify-content-center">
                <div class="top-signup text-right d-flex justify-content-end pt-5 pb-lg-0 pb-10">
                    <span class="font-weight-bold text-muted font-size-h4">¿Teniendo problemas?</span>
                    <a href="javascript:;" class="font-weight-bolder text-primary font-size-h4 ml-2" id="kt_login_signup">Consigue ayuda</a>
                </div>
            </div>
            <!--end::Top-->
                    ...
                    <form class="form" novalidate="novalidate" id="kt_login_signup_form">
                        ...
                        <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                            ...
                            <div class="pb-10 pb-lg-15">
                                <h3 class="font-weight-bolder text-dark display5">Informacion del denunciante</h3>
...
<!--                                </div>-->
                            ...
                            <div class="form-group">
                                <label class="font-size-h6 font-weight-bolder text-dark">Solicitud reserva de identidad</label>
<!--                                <input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="fname" placeholder="First Name" value="" />-->
                                <div class="radio-inline" style="background: white;padding: 2em">
                                    <label class="radio">
                            ...
                            <!--begin::Form Group-->
                            <div class="form-group">
                                <label class="font-size-h6 font-weight-bolder text-dark">Nombre y Apellidos</label>
                                <input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="nombre" placeholder="Nombre Completo" value="" />
                            </div>
                            <!--end::Form Group-->

                            <!--begin::Form Group-->
                            <div class="form-group">
                                <label class="font-size-h6 font-weight-bolder text-dark">Cedula de identidad</label>
                                <input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="ci" placeholder="Ci" value="" />
                            </div>
                            <!--end::Form Group-->
                            <!--begin::Form Group-->
                            <div class="form-group">
                                <label class="font-size-h6 font-weight-bolder text-dark">Telefono de referencia</label>
                                <input type="tel" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="Telefono" placeholder="phone" value="" />
                            </div>
                            <!--end::Form Group-->
                            <!--begin::Form Group-->
                            <div class="form-group">
                                <label class="font-size-h6 font-weight-bolder text-dark">Correo electronico</label>
                                <input type="email" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="email" placeholder="email" value="" />
                            </div>
                            <!--end::Form Group-->
                            <!--begin::Form Group-->
                            <div class="form-group">
                                <label class="font-size-h6 font-weight-bolder text-dark">Direccion</label>
                                <input type="text" class="form-control h-auto py-7 px-6 border-0 rounded-lg font-size-h6" name="direccion" placeholder="Direccion" value="" />
                            </div>
                            <!--end::Form Group-->
                        </div>
                        <!--end: Wizard Step 1-->
                        ...
                        <div class="pb-5" data-wizard-type="step-content">
                            ...
                            <div class="pt-lg-0 pt-5 pb-15">
                                <h3 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Infomacion del denunciado(s)</h3>
<!--                                <div class="text-muted font-weight-bold font-size-h4">-->
